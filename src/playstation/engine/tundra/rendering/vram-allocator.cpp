...
namespace td {
    ...
    // Each pixel is 
    Vec2<uint16> VramAllocator::allocate_clut_4() {
        GridAllocator::Result result = global_allocator.allocate(
            32,
            1
        );
    ...
    Vec2<uint16> VramAllocator::allocate_clut_8() {
        GridAllocator::Result result = global_allocator.allocate(
            512,
            1
        );
    ...
    TextureAllocationResult VramAllocator::allocate_texture(TextureMode mode, uint8 width, uint8 height) {
