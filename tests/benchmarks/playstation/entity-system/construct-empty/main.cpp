...
extern void update(td::EngineSystems& engine_systems, const td::FrameTime&) {
    ...
    td::Duration duration_medium = measure(engine_systems.time, iterate_components<LargeComponent>);
    td::Duration duration_big = measure(engine_systems.time, iterate_components<MediumComponent>);
