...
td::Duration construct_bottom_up(td::ITime& time, const td::List<td::uint32>& hierarchy) {
...
extern void update(td::EngineSystems& engine_systems, const td::FrameTime&) {
    ...
    td::Duration duration_small = construct_bottom_up(engine_systems.time, HIERARCHY_SMALL);
    td::Duration duration_medium = construct_bottom_up(engine_systems.time, HIERARCHY_MEDIUM);
    td::Duration duration_large = construct_bottom_up(engine_systems.time, HIERARCHY_LARGE);
    td::Duration duration_wide = construct_bottom_up(engine_systems.time, HIERARCHY_WIDE);
