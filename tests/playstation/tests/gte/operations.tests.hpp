...
namespace td::gte_operations_tests {
    ...
    TD_TEST("gte/operations/matrix-vector-multiply/identity") {
        
        td::Vec3<td::Fixed32<12>> result;

        td::Vec3<td::Fixed32<12>> v0 { 0 };

        result = td::gte::multiply(IDENTITY, v0);
        TD_TEST_ASSERT_EQUAL(result, v0);
    ...
    TD_TEST("gte/operations/matrix-vector-multiply/zero") {
        
        Vec3<td::Fixed32<12>> result;

        Vec3<td::Fixed32<12>> v_zero { 0 };
        Mat3x3<td::Fixed16<12>> m_zero { 0 };

        Vec3<td::Fixed32<12>> v_non_zero { 1, 2, 3 };
        Mat3x3<td::Fixed16<12>> m_non_zero = from_double<td::Fixed16<12>>(
            0.125, 0.250, 0.5,
            0.250, 0.5, 0.75,
            0.5, 0.75, 1
        );        
        
        result = td::gte::multiply(m_zero, v_zero);
        TD_TEST_ASSERT_EQUAL(result, v_zero);

        result = td::gte::multiply(m_non_zero, v_zero);
        TD_TEST_ASSERT_EQUAL(result, v_zero);

        result = td::gte::multiply(m_zero, v_non_zero);
        TD_TEST_ASSERT_EQUAL(result, v_zero);
    }

    TD_TEST("gte/operations/matrix-vector-multiply/basic") {
        
        Vec3<td::Fixed32<12>> result;

        Vec3<td::Fixed32<12>> v { 1, 2, 4 };
        Mat3x3<td::Fixed16<12>> m = from_double<td::Fixed16<12>>(
            0.125, 0.250, 0.5,
            0.250, 0.5, 0.75,
            0.5, 0.75, 1
        );        
        ...
        result = td::gte::multiply(m, v);
        TD_TEST_ASSERT_EQUAL(result, expected);
    }

    TD_TEST("gte/operations/matrix-matrix-multiply/identity") {
    ...
    TD_TEST("gte/operations/matrix-matrix-multiply/basic") {
